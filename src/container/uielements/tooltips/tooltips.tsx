        ...
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Tooltip Directions</Card.Title>
            ...
            <Card.Body>
              <div className="btn-list">
                {Tooltipdirtooltip.map((idx: any) => (
                  <OverlayTrigger
                    placement={idx.text}
                    overlay={<Tooltip>Tooltip on {idx.text} </Tooltip>}
                    key={Math.random()}
                  >
...
Tooltip on {idx.text}
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Colored Tooltips</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="btn-list">
                ...
                <OverlayTrigger
                  placement="bottom"
                  overlay={
                    <Tooltip className="tooltip-info">Info Tooltip </Tooltip>
                  }
                >
                  <Button
                    type="button"
                ...
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip className="tooltip-success">
                      Success Tooltip{" "}
                    </Tooltip>
                  }
                >
                ...
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip className="tooltip-light">Light Tooltip </Tooltip>
                  }
                >
                  <Button
                    type="button"
                ...
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip className="tooltip-dark">Dark Tooltip </Tooltip>
                  }
                >
                  <Button
                    type="button"
...
Tooltip on {idx.text}
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Tooltips on links</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <p className="text-muted mb-0">
                ...
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip className="tooltip-primary">Link Tooltip </Tooltip>
                  }
                >
  ...
  <Link to="#" className="text-primary">Tooltip</Link>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>With an SVG's</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              {SVGtooltip.map((idx) => (
                <OverlayTrigger
                  ...
                  placement="top"
                  overlay={
                    <Tooltip className={`tooltip-${idx.color}`}>
                      {idx.text}{" "}
                    </Tooltip>
                  }
                >
            ...
            <Collapse in={open4} className="card-body">
              <pre>
                <code>{`<OverlayTrigger placement="top" overlay={
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <OverlayTrigger
                overlay={
                  <Tooltip id="tooltip-disabled">Default tooltip!</Tooltip>
                }
              >
   ...
   <Button disabled style={{ pointerEvents: 'none' }}>
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Tooltip For Images</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <OverlayTrigger
                placement="top"
                overlay={
                  <Tooltip className="tooltip-primary">Alex Carey</Tooltip>
                }
              >
                <Link
                  to="#"
              ...
              <OverlayTrigger
                placement="top"
                overlay={
                  <Tooltip className="tooltip-primary">Marina Kai</Tooltip>
                }
              >
                <Link
                  to="#"
              ...
              <OverlayTrigger
                placement="top"
                overlay={
                  <Tooltip className="tooltip-primary">Tim Cook</Tooltip>
                }
              >
                <Link
                  to="#"
