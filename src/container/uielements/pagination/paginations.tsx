    ...
    <Pagination.Item as="li" href="#">3</Pagination.Item>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Center & Right Aligned Pagination</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Pagination className="justify-content-end mb-0">
    ...
    <Pagination.Item  href="#">Next
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Active and disabled states</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
            ...
            <Card.Body className="card-body d-flex flex-wrap">
              <nav aria-label="..." className="me-3">
                <Pagination className="pagination">
                  <Pagination.Item disabled>Previous</Pagination.Item>
                  <Pagination.Item href="#">1</Pagination.Item>
                  <Pagination.Item active aria-current="page" href="#">
                    2
                  </Pagination.Item>
                  <Pagination.Item href="#">Next</Pagination.Item>
                </Pagination>
    ...
    <Pagination.Item  href="#">Next
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Pagination Style-1</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<i className="ri-arrow-right-s-line align-middle"></i>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Pagination Style-2</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
            ...
            <Card.Body>
              <nav aria-label="Page navigation" className="pagination-style-2">
                <Pagination className="mb-0 flex-wrap">
                  ...
                  <Pagination.Item as="li" active href="#">
                    1
                  </Pagination.Item>
                  <Pagination.Item as="li" href="#">
                    2
...
<i className="ri-arrow-right-s-line align-middle"></i>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Pagination Style-3</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
            ...
            <Card.Body>
              <nav aria-label="Page navigation" className="pagination-style-3">
                <Pagination className=" mb-0 flex-wrap">
                  <Pagination.Item as="li" disabled>
                    Prev
                  </Pagination.Item>
                  <Pagination.Item as="li" active href="#">
                    1
...
href="#">next
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Pagination Style-4</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
