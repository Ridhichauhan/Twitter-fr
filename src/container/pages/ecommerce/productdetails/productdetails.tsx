                  ...
                  <Row>
                    ...
                    >
                      <Swiper
                        ...
                        className="mySwiper2 swiper swiper-preview swiper-preview-details bg-light"
                      >
                        <SwiperSlide>
                          <img
                            className="img-fluid"
                                ...
                                <Link to="#">
                                  <div className="d-flex align-items-top">
                                    ...
                                    <div className="flex-fill">
                                      <p className="mb-1 fs-14 fw-semibold similar-product-name text-truncate">
                              ...
                              <td>
                                <Link to="#">
                                  <div className="d-flex align-items-top">
                                    ...
                                    <div className="flex-fill">
                                      <p className="mb-1 fw-semibold similar-product-name text-truncate">
                  ...
                  <Row className="row gx-5">
                    <Col xl={8} className="mt-xxl-0 mt-3">
                      <div>
                        ...
                        <div className="row mb-4">
                          <Col xxl={3} xl={12}>
                            <p className="mb-1 lh-1 fs-11 text-success fw-semibold">
                              Special Offer
                            </p>
                            <p className="mb-1">
                              <span className="h3">
                                <sup className="fs-14">$</sup>1,299
                                <sup className="fs-14">.00</sup>
                              </span>
                              <span className="ms-3 badge bg-danger-transparent">
                                50% Off
                              </span>
                            </p>
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <label
                                className="btn btn-sm btn-outline-light text-default"
                                htmlFor="type1"
                              >
                                GPS
                              </label>
                          ...
                          <Col
                            ...
                            className=" mt-xxl-0 mt-3"
                          >
                            <p className="mb-2 fs-15 fw-semibold">
                              Strap Material
                            </p>
                            <div
                              className="btn-group"
                        ...
                        <div className="mb-4">
                          <p className="fs-15 fw-semibold mb-1">
                            Description :
                          </p>
                                ...
                                <table className="table table-bordered text-nowrap">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        Heart rate sensor,GPS,Wifi
                                        calling,SAmoled display e.t.c
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                          ...
                          <Row>
                            <Col xl={6}>
                              <ul className="mb-0">
                                ...
                                <li className="text-muted mb-2">SpO2</li>
                                <li className="text-muted mb-2">
                                  30+ sports mode
                                </li>
                                <li className="text-muted mb-2">
                                ...
                                <li className="text-muted">Water resistant</li>
                              </ul>
                            </Col>
                            <Col xl={6}>
                              <ul className="mb-0">
                        ...
                        <div className="mb-0">
                          <p className="fs-15 fw-semibold mb-3">
                            Reviews & Ratings :
                          </p>
                          <Row>
                            <Col xxl={4} xl={12} lg={12} md={12} sm={12}>
                              ...
                              <div className="d-flex align-items-center mb-3">
                                <div className="fs-12 me-2 fw-semibold">
                                  5 <i className="ri-star-fill fs-10"></i>
                                </div>
                                <ProgressBar
                                  className="progress progress-xs flex-fill"
                                  variant="success"
                                  now={55}
                                />
                                <div className="text-muted ms-2 fs-12">
                                  (10,893)
                                </div>
                              </div>
                              <div className="d-flex align-items-center mb-3">
                                <div className="fs-12 me-2 fw-semibold">
                                  4 <i className="ri-star-fill fs-10"></i>
                                </div>
                                <ProgressBar
                                  className="progress progress-xs flex-fill"
                                  variant="success"
                              ...
                              <div className="d-flex align-items-center mb-3">
                                <div className="fs-12 me-2 fw-semibold">
                                  3 <i className="ri-star-fill fs-10"></i>
                                </div>
                                <ProgressBar
                                  className="progress progress-xs flex-fill"
                                  variant="success"
                              ...
                              <div className="d-flex align-items-center mb-3">
                                <div className="fs-12 me-2 fw-semibold">
                                  2 <i className="ri-star-fill fs-10"></i>
                                </div>
                                <ProgressBar
                                  className="progress progress-xs flex-fill"
                                  variant="warning"
                              ...
                              <div className="d-flex align-items-center">
                                <div className="fs-12 me-2 fw-semibold">
                                  1 <i className="ri-star-fill fs-10"></i>
                                </div>
                                <ProgressBar
                                  className="progress progress-xs flex-fill"
                                  variant="danger"
                            ...
                            >
                              <div className="border p-3">
                                ...
                                <div className="ps-sm-4 ps-0 mb-3">
                                  <p className="fw-semibold mb-1 ps-2">
                                    Wonderful product&#128512;
                                  </p>
                    ...
                    <Col xl={4} className="mt-xxl-0 mt-3">
                      <div className="mb-5">
                        <div className="offer-promotion mb-4">
                          <div className="d-xxl-flex d-lg-block d-sm-flex flex-wrap justify-content-between align-items-center">
                            <div className="text-warning">
                              ...
                              <Link className="fs-10 text-warning ms-1" to="#">
                                T&C.
                              </Link>
                            </div>
                            <div className="mt-sm-0 mt-2">
                              <span className="bg-warning-transparent text-default fs-12 offer-details mb-0">
                                Get it for{" "}
                        ...
                        <div className="mb-4">
                          <ul className="list-group">
                            <li className="list-group-item">
                              <div className="lh-1">
                                <span className="text-success fw-semibold fs-14 d-flex align-items-center">
                                  <i className="ti ti-discount-2 fs-18 me-1"></i>
                                  3 Available offers
                                </span>
                              </div>
                            </li>
                        ...
                        <div
                          className="alert alert-light mb-4 fs-12 text-muted"
                          role="alert"
                        >
                          <Link to="#">
                            <i className="ri-map-pin-line me-1 align-middle text-primary fs-15 d-inline-block"></i>
                          </Link>
